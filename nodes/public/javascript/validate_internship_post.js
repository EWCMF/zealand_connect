function validate_internship_post(e) {
  ...
  //Vedhæftet tekstfil
  if (document.getElementById('companyDoc').files[0] != null && document.getElementById('companyDoc').files[0].size >= 1024) {
  ...
  //Vedhæftet logo
  if (document.getElementById('companyLogo').files[0] != null && document.getElementById('companyLogo').files[0].size >= 1024) {
